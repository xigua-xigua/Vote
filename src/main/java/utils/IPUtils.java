...
public class IPUtils {
    ...
    private static String apiUrl = "http://dev.kdlapi.com/api/getproxy/?orderid=954114629551026&num=10&b_pcchrome=1&b_pcie=1&b_pcff=1&protocol=1&method=1&an_tr=1&an_an=1&an_ha=1&dedup=1&format=json&sep=1";
